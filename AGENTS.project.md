...
- Eleições only even years 2000–2050: federal if year%4===2, municipal if year%4===0. List title “Eleição Federal/Municipal”, tag (1º turno)/(2º turno). 1º first Sunday of October. **2º only if Almanaque do ano confirmed** (known federal 2002–2022, TSE, Wikipedia PT+EN, or user toggle). Never invent 2º on last Sunday.
