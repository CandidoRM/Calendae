//#region node_modules/.nitro/vite/services/ssr/assets/db-BoLgordd.js
...
var _0002_calendae_cloud_default = "create table if not exists calendae_cloud (\n  user_id    text primary key,\n  payload    jsonb not null,\n  updated_at timestamptz not null default now()\n);\n";
/**
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_calendae_cloud.sql": _0002_calendae_cloud_default
		});
