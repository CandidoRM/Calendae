...
import { n as auth } from "./server-CrmaWJSe.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DDyPym62.js
...
var styles_default = "/assets/styles-CITFlVwC.css";
var APP_NAME = "Calendae";
...
var $$splitComponentImporter$1 = () => import("./routes-B7H0fKm0.mjs").then((n) => n.t);
var Route$3 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-CTylt5D5.mjs");
var Route$2 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var Route$1 = createFileRoute("/api/backup")({ server: { handlers: { GET: async () => {
	const { spawn } = await import("node:child_process");
	const { readFile } = await import("node:fs/promises");
	await new Promise((resolve, reject) => {
		const child = spawn("python3", ["scripts/make-calendae-backup.py", "/tmp/calendae-backup.zip"], { cwd: "/workspace" });
		let err = "";
		const timer = setTimeout(() => {
			child.kill("SIGKILL");
			reject(/* @__PURE__ */ new Error("backup timeout"));
		}, 25e3);
